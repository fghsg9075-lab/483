                  ...
                  <div className="space-y-4 mb-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8 mx-1">
                          ...
                          <div className="h-32 rounded-2xl overflow-hidden shadow-lg relative border-2 border-slate-900">
                              <BannerCarousel
                                  slides={[
                                      { id: 'discount', image: 'https://img.freepik.com/free-vector/gradient-sale-background_23-2148934477.jpg', title: 'SPECIAL OFFER', subtitle: 'Limited Time Deal', link: '' },
                                      { id: 'video', image: 'https://img.freepik.com/free-vector/gradient-education-poster-template_23-2150338779.jpg', title: 'ULTRA VIDEO', subtitle: 'HD Lectures', link: '' },
                                      { id: 'pdf', image: 'https://img.freepik.com/free-vector/gradient-education-flyer-template_23-2150338784.jpg', title: 'ULTRA PDF', subtitle: 'Premium Notes', link: '' },
                                      { id: 'mcq', image: 'https://img.freepik.com/free-vector/online-tutorials-concept_52683-37480.jpg', title: 'ULTRA MCQ', subtitle: 'Test Series', link: '' },
                                      { id: 'audio', image: 'https://img.freepik.com/free-vector/audiobook-concept-illustration_114360-6070.jpg', title: 'ULTRA AUDIO', subtitle: 'Listen & Learn', link: '' },
                                      { id: 'ai', image: 'https://img.freepik.com/free-vector/ai-technology-brain-background-vector-digital-transformation-concept_53876-112222.jpg', title: 'AI TOUR', subtitle: 'Ask Doubts Instantly', link: '' }
                                  ].filter(s => s.id !== 'discount' || (showDiscountBanner && discountStatus === 'ACTIVE'))}
                          ...
                          <div className="grid grid-cols-1 gap-3 md:col-span-2">
                              ...
                              <div className="grid grid-cols-2 gap-3">
                                {hasPermission('f101') && <button onClick={() => onTabChange('AI_CHAT')} className="h-24 bg-indigo-600 rounded-2xl shadow-lg flex flex-col items-center justify-center text-white relative overflow-hidden group">
                                    ...
                                    <span className="text-xs font-black relative z-10">ASK DOUBTS</span>
                                    <span className="text-[8px] opacity-70 relative z-10">AI Tutor</span>
                                </button>}
                              ...
                              {/* Row 2: Custom Page (Full Width) */}
                              {hasPermission('f32') && <button onClick={() => onTabChange('CUSTOM_PAGE')} className="h-24 w-full bg-slate-800 rounded-2xl shadow-lg flex flex-col items-center justify-center text-white relative overflow-hidden group">
                                  ...
                                  <span className="text-xs font-black relative z-10">CUSTOM PAGE</span>
                                  <span className="text-[8px] opacity-70 relative z-10">Explore More</span>
                              </button>}
                          </div>
                      </div>
                  </div>
